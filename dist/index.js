...
exports.AmbientOcclusionMesh = void 0;
const THREE = __importStar(__webpack_require__(396));
class AmbientOcclusionMesh extends THREE.Mesh {
    scene;
    renderer;
    renderTarget;
    camera;
    context;
    buffer;
    constructor(geometry, resolution, scene, renderer, baseColor, emissive) {
        ...
        const colors = new THREE.BufferAttribute(new Float32Array(size * 3), 3);
        const light = new THREE.BufferAttribute(new Float32Array(size * 3), 3);
    ...
    getMeanColor(colors, i) {
        this.renderer.readRenderTargetPixels(this.renderTarget, 0, 0, this.renderTarget.width, this.renderTarget.height, this.buffer);
...
exports.AmbientOcclusionMesh = AmbientOcclusionMesh;
//# sourceMappingURL=ambientOcclusionMesh.js.map
...
const ambientOcclusionMesh_1 = __webpack_require__(996);
